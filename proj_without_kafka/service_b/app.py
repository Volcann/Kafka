...
SERVICE_C_URL = "http://service_c:5003/count"
...
def analyze():
    ...
    if not data or 'text' not in data:
        debug_event("Service_B", "Service_A", "RESP_OUT", module="Error")
    ...
    if emotion == "Angry":
        debug_event("Service_B", "Service_B", "PROCESSING", module="Alerting")
    ...
    try:
        ...
        debug_event("Service_B", "Service_A", "RESP_OUT", module="DB Error")
